...
//            mAuthTask.execute((Void) null);
            ...
            Retrofit retrofit = new Retrofit.Builder()
                    .baseUrl("http://192.168.43.125:8080/projectvocabulary/")
                    .addConverterFactory(GsonConverterFactory.create())
                    .client(client)
                    .build();

            ProjectVocabularyApi service = retrofit.create(ProjectVocabularyApi.class);
                service.login(new LoginRequestDto(email, password)).enqueue(new Callback<User>() {
                    @Override
                    public void onResponse(Call<User> call, Response<User> response) {
                        ...
                        if(response.isSuccessful()) {
                            ...
                            new AlertDialog.Builder(LoginActivity.this).setMessage("BŁĄÐ").show();
                        }
